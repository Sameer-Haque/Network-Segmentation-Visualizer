...
def main():
    ...
    try:
        ...
        nodemap_out = os.path.join(os.path.dirname(out), "snmp_devices.py")
        snmp_devices = [[h["ip"], "161", args.community] for h in hosts]
        with open(nodemap_out, "w") as f:
            f.write("# Auto-generated by generator.py — do not edit manually\n")
            f.write(f"snmp_devices = {snmp_devices!r}\n")
